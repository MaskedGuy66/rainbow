...
export default function AddTransaction() {
  ...
  const handleDelete = () => {
    if (!id || id === "null" || id === "undefined") {
      if (Platform.OS === 'web') {
        ...
        Alert.alert("Loi", "Khong tim thay ID giao dich de xoa");
      }
      return;
    }
    ...
    if (Platform.OS === 'web') {
      ...
      Alert.alert(
        "Xoa giao dich",
        `Ban co chac muon xoa giao dich ${type} nay khong?`,
        [
  ...
  const performDelete = async () => {
    ...
    try {
      const user = auth.currentUser;
      if (!user) {
        Alert.alert("Loi", "Nguoi dung chua dang nhap");
        return;
      }
      ...
      if (!docSnap.exists()) {
        Alert.alert("Loi", "Giao dich khong ton tai");
        return;
      }
      ...
      console.error("Loi xoa giao dich:", error);

      let errorMessage = "Khong the xoa giao dich.";
      if (error.code === 'permission-denied') {
        errorMessage = "Khong co quyen xoa giao dich.";
      } else if (error.code === 'not-found') {
        errorMessage = "Giao dich khong ton tai.";
      }
      ...
      <Modal visible={deleteModalVisible} transparent animationType="fade">
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <Text style={styles.modalTitle}>Xoa giao dich</Text>
            ...
            <View style={styles.modalButtons}>
              ...
              <TouchableOpacity
                ...
                onPress={performDelete}
              >
                <Text style={styles.modalDeleteText}>Xoa</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
